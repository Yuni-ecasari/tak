...
exports.allmenu =  (getLimit, senderNumber, getBalance, isPremium, thisHit, publik, sender, prefix, pushname) => {
try{ 
...
${week}, ${calender} 
 ...
 ᥬ😀᭄  Nama : ${pushname}
 ᥬ😀᭄  Status : ${isPremium ? '🎫 Premium' : 'Free'}
 ᥬ😀᭄  Limit : ${isPremium ? 'Unlimited' : `${getLimit(senderNumber)}`}
 ᥬ😀᭄  Saldo : Rp ${balance}
 ᥬ😀᭄  Running On : *${runWith}*
 ᥬ😀᭄  Mode : ${publik ? "Public" : "Self"}
 ᥬ😀᭄  Time : ${timeWib} WIB 
 ᥬ😀᭄  Time : ${timeWit} WIT 
 ᥬ😀᭄  Time : ${timeWita} WITA  
 ᥬ😀᭄  Islamic : ${dateIslamic}
 ᥬ😀᭄  Hit Today : ${thisHit.toLocaleString()}
 ᥬ😀᭄  Total Feature : ${totalFitur()}
 ᥬ😀᭄  Total Error : ${JSON.parse(fs.readFileSync('./database/listerror.json')).length}
 ᥬ😀᭄  Total User : ${JSON.parse(fs.readFileSync('./database/user.json')).length.toLocaleString()}
 ᥬ😀᭄  User Banned : ${JSON.parse(fs.readFileSync('./database/banned.json')).length}
 ᥬ😀᭄  User Blocked : ${JSON.parse(fs.readFileSync('./database/userblocked.json')).length.toLocaleString()}
 ᥬ😀᭄  Cmd Blocked : ${JSON.parse(fs.readFileSync('./database/blockcmd.json')).length} 
`}
...
return`
  ...
  ├${prefix}orquoted ${feat("orquoted")? yes :no}
  ...
  ├${prefix}settextmenu ${feat("settextmenu")? yes :no}
  ├${prefix}settextfitur ${feat("settextfitur")? yes :no}
  ...
  ├${prefix}infobot ${feat("infobot")? yes :no}
  ...
  ├${prefix}claim ${feat("claim")? yes :no}
  ├${prefix}shop ${feat("shop")? yes :no}
  ├${prefix}cekprem ${feat("cekprem")? yes :no}
  ...
  ├${prefix}family100 ${feat("family100")? yes :no}
  ...
  ├${prefix}tebakanime2 ${feat("tebakanime2")? yes :no}
  ...
  ├${prefix}addcmdowner ${feat("addcmdowner")? yes :no}
  ├${prefix}addcmdlimit ${feat("addcmdlimit")? yes :no}
  ├${prefix}addcmdprem ${feat("addcmdprem")? yes :no}
  ├${prefix}delowner ${feat("delowner")? yes :no}
  ├${prefix}dellimit ${feat("dellimit")? yes :no}
  ├${prefix}delprem ${feat("delprem")? yes :no}
  ├${prefix}delcmdowner ${feat("delcmdowner")? yes :no}
  ├${prefix}delcmdlimit ${feat("delcmdlimit")? yes :no}
  ├${prefix}delcmdprem ${feat("delcmdprem")? yes :no}
  ├${prefix}listowner ${feat("listowner")? yes :no}
  ├${prefix}listlimit ${feat("listlimit")? yes :no}
  ├${prefix}listprem ${feat("listprem")? yes :no}
  ├${prefix}listcmdowner ${feat("listcmdowner")? yes :no}
  ├${prefix}listcmdlimit ${feat("listcmdlimit")? yes :no}
  ├${prefix}listcmdprem ${feat("listcmdprem")? yes :no}
  ...
  ├${prefix}bugsanted ${feat("bugsanted")? yes :no}
  ├${prefix}bugsantedgc ${feat("bugsantedgc")? yes :no}
